...
<head>
  ...
  *::before {
  ...
  <script type="text/JavaScript">
	$('#covid19').connections({to: 'gallery__item'});
  </script>
...
<body>
  <div class="container" style="width: 100%; margin: 1em auto;" markdown="0">
    <div class="gallery" markdown="0">
      <figure class="gallery__item gallery__item--1" id="covid19">
      ...
      <figure class="gallery__item gallery__item--2" id="covid19narratives">
      ...
      <figure class="gallery__item gallery__item--3" id="gem">
      ...
      <figure class="gallery__item gallery__item--4" id="purespace">
      ...
      <figure class="gallery__item gallery__item--5" id="stage">
      ...
      <figure class="gallery__item gallery__item--6" id="vibrance">
